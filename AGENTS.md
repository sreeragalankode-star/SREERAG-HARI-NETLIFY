# AGENTS.md — Sreerag Hari Website

This document is for AI agents and developers. It describes the current architecture after the site was rebuilt for Sreerag Hari, an Indian Santoor artist.

## Project Overview

A personal artist website for Sreerag Hari, a Santoor musician based in London. Built with TanStack Start and deployed on Netlify.
